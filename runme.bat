...
set "logFile=%~dp0Logs\stardebloat-Run.log"
...
set "SCRIPT_PATH=%~dp0stardebloat.ps1"

if defined wtPath (
    call :Log Launching stardebloat.ps1 with Windows Terminal...
    ...
    call :Log Windows Terminal not found. Using default PowerShell to launch stardebloat.ps1...
...
echo https://github.com/Raphire/stardebloat/issues
goto :EOF
