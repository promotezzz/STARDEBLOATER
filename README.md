...
This method supports command-line parameters to customize the behaviour of the script. Please click [here](https://github.com/Raphire/stardebloat/wiki/Command%E2%80%90line-Interface#parameters) for more information.
...
<details>
  ...
  1. [Download the latest version of the script](https://github.com/Raphire/stardebloat/releases/latest), and extract the .ZIP file to your desired location.
  2. Navigate to the stardebloat folder
...
<details>
  ...
  4. In PowerShell, navigate to the directory where the files were extracted. Example: `cd c:\stardebloat`
...
Below is an overview of the key features and functionality offered by stardebloat. You can visit the [the wiki](https://github.com/Raphire/stardebloat/wiki) for more details.

> [!Tip]
> All of the changes made by stardebloat can easily be reverted and almost all of the apps can be reinstalled through the Microsoft Store. You can visit [the wiki](https://github.com/Raphire/stardebloat/wiki/Reverting-Changes) for more information on reverting changes.

#### App Removal

- Remove a wide variety of preinstalled apps. Click [here](https://github.com/Raphire/stardebloat/wiki/App-Removal) for more info.
...
- Ability to [apply changes to a different user](https://github.com/Raphire/stardebloat/wiki/Advanced-Features#running-as-another-user), instead of the currently logged in user.
- [Sysprep mode](https://github.com/Raphire/stardebloat/wiki/Advanced-Features#sysprep-mode) to apply changes to the Windows Default user profile. Which ensures, all new users will have the changes automatically applied to them.

## Contributing

We welcome contributions of all kinds! Please see our [Contributing Guidelines](https://github.com/Raphire/stardebloat/blob/master/.github/CONTRIBUTING.md) for detailed instructions on how to get started and best practices for contributing.

## License

stardebloat is licensed under the MIT license. See the LICENSE file for more information.
