function Show-MainWindow {
    ...
    # Load custom Death Star PNG image
    $DeathStarImage = $window.FindName('DeathStarImage')
    if ($DeathStarImage) {
        $imagePath = Join-Path $script:AssetsPath "Images\deathstar.png"
    ...
    $menuDocumentation.Add_Click({ Start-Process "https://github.com/Raphire/stardebloat/wiki" })
    $menuReportBug.Add_Click({ Start-Process "https://github.com/Raphire/stardebloat/issues" })
